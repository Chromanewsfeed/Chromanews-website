...
const T4_FEEDS = [
  ...
  {name:'Paul Krugman',     type:'rss', url:'https://api.rss2json.com/v1/api.json?rss_url=https://www.nytimes.com/svc/collections/v1/publish/https://www.nytimes.com/column/paul-krugman/rss.xml', lean:'center-left', reach:3},
  {name:'Thomas Friedman',  type:'rss', url:'https://api.rss2json.com/v1/api.json?rss_url=https://www.nytimes.com/svc/collections/v1/publish/https://www.nytimes.com/column/thomas-l-friedman/rss.xml', lean:'center-left', reach:3},
  {name:'Fareed Zakaria',   type:'rss', url:'https://api.rss2json.com/v1/api.json?rss_url=https://feeds.washingtonpost.com/rss/opinions/fareed-zakaria', lean:'center-left', reach:3},
  {name:'Ezra Klein',       type:'rss', url:'https://api.rss2json.com/v1/api.json?rss_url=https://www.nytimes.com/svc/collections/v1/publish/https://www.nytimes.com/column/ezra-klein/rss.xml', lean:'center-left', reach:2},
  {name:'Glenn Greenwald',  type:'youtube', id:'UCi_GmMBOCrwwDLOhBRHOeZA', lean:'center',       reach:2},
  {name:'Matt Taibbi',      type:'rss', url:'https://api.rss2json.com/v1/api.json?rss_url=https://www.racket.news/feed', lean:'center', reach:2},
  {name:'Andrew Sullivan',  type:'rss', url:'https://api.rss2json.com/v1/api.json?rss_url=https://andrewsullivan.substack.com/feed', lean:'center', reach:2},
